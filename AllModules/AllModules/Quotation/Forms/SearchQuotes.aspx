<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchQuotes.aspx.cs" Culture ="en-GB"  Theme="Default" MasterPageFile ="~/Quotation/Quotation.Master" Inherits="Quotation.Forms.SearchQuotes" %>
...
<asp:Content ID="Quotation" ContentPlaceHolderID="main" runat="server">  
<ul id="breadcrumb">
...
<table >
  ...
  <asp:Panel ID="AddDeleteButtonPanel" runat="server">
        ...
        <td>
         <asp:ImageButton runat="server" ID="DeleteButton" AlternateText="Delete Quote" ToolTip="Delete Quote"
         OnClick="DeleteButton_Click" ImageUrl="~/Images/iBin.gif" OnClientClick="return confirm('Are you sure you want to delete this Quotation! Do you want to continue ?')" />         
        </td>         
        <%--<td>
        <asp:ImageButton runat="server" ID="AddNewButton" AlternateText="Add New Quote" ToolTip="Add New Quote"
   ...
   <div>
    <br />
    <asp:GridView ID="QuotationGridView" runat="server" AutoGenerateEditButton="false" 
    AutoGenerateDeleteButton="false" AutoGenerateColumns="false" SkinID="metro" OnRowCommand="QuotationGridView_RowCommand"
    ShowFooter="true"   DataKeyNames="ID" DataSourceID="ODODS" OnRowCreated="QuotationGridView_RowCreated"  >  
    
    <Columns>   
         
    <asp:TemplateField ItemStyle-Width="10px"> 
    <HeaderTemplate>
    <asp:ImageButton runat="server" ID="Copy" ImageUrl="~/Images/imgCopy.png" ToolTip="Create a copy from existing Quote" /> <%--OnClick="CopyBtnClick" --%>
    </HeaderTemplate>    
     <ItemTemplate>   
    ...
    <%-- <td style="border:0px;width:10%;">Requested For</td>--%>
     ...
     <td style="border:0px;width:100px;"><%# Eval("QuoteDate","{0:dd/MM/yyyy}")  %> </td>
     ...
     <asp:Panel ID="pnlQuotationItem" runat="server" CssClass="LeftSide"  Width="100%"     >
    ...
    TypeName="Quotation.BusLogic.QuoteItem" ConflictDetection="CompareAllValues"
    SelectMethod="GetQuoteItems" DataObjectTypeName="Quotation.Data.QuoteItemData" >
    <SelectParameters>   
    <asp:Parameter Name="QuoteID" Type="String" DefaultValue="" />
    </SelectParameters>    
    </asp:ObjectDataSource>         
     <ajax:CollapsiblePanelExtender ID="cpe" runat="Server"  
     TargetControlID="pnlQuotationItem" CollapsedSize="0" Collapsed="True"  
     ...
     CollapsedImage="~/Quotation/Images/iADD.bmp" ExpandDirection="Vertical" />
    ...
    TypeName="Quotation.BusLogic.Quote" ConflictDetection="CompareAllValues"
    SelectMethod="GetQuotes" DataObjectTypeName="Quotation.Data.QuoteData" CacheDuration="0" >
    <SelectParameters> 
