<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageOrder.aspx.cs"  MasterPageFile="~/PurchaseOrder/PurchaseOrder.Master" 
Theme="Default" Inherits ="PurchaseOrder.Forms.ManagePurchase" %>
...
<script type="text/javascript">
    ...
    function PrintReportInNewWindow(PO,type) {
        //window.open('/QOModule/Reports/PurchaseOrderReport.aspx?QID=' + PO, 'NewWindow', 'toolbar=no');
        //window.open('/PurchaseOrder/Reports/GeneratePurchase.aspx?ID=' + PO, 'NewWindow', 'toolbar=no');
        var rootPath = '<%= ConfigurationManager.AppSettings["PurchaseRootPath"] %>';
        
        if (type == 'PDF') {
            window.open(rootPath + 'GeneratePurchase.aspx?ID=' + PO + '&Type=PDF', 'NewWindow', 'toolbar=no');
        } else {
        window.open(rootPath + 'GeneratePurchase.aspx?ID=' + PO + '&Type=Excel', 'NewWindow', 'toolbar=no');
        }
    }
...
<ul id="breadcrumb">
    ...
    <li style="width:80px;"><a href="SearchOrders.aspx" title="Purchase"><b>I&nbsp;-&nbsp;Purchase</b></a> </li>
    <li>Create / Manage Purchase</li>
    </ul>
    <div>
...
<asp:Panel ID="AEP" runat="server" >
    ...
    <tr>
            ...
            <td>
             ...
             <td>
                <asp:Button ID="btnSubmit" runat="server" Text="Submit" OnClientClick="return confirm('No changes will be allowed after you submit. Are you sure you want to submit this PurchaseOrder');" OnClick="btnSubmit_Click" />
            </td>            
            <td>
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <table  class="TableClass"  cellpadding="0px" cellspacing="0px">
                        <tr class="theadColumn">
                            <td>
                                <asp:Label ID="LblQO" runat="server"   Text="Purchase Number" />
                            </td>
                            <td>
                        ...
                        <tr>
                           ...
                           <td>
                               <asp:Label ID="PurchaseDateLbl" Text='<%# Eval("PurchaseDate","{0:dd/MM/yyyy}")  %>' runat="server"></asp:Label>                               
                        ...
                        <tr class="theadColumn">
                            ...
                            <td > <asp:Label ID="PurchaseOrderTotal"  Text="Total" runat="server" /></td>
                            <td style="padding-left:30px;font-weight:normal; text-align:left;">
                        ...
                        <tr >
                            ...
                            <td >  <asp:Label ID="PurchaseOrderTotal1"  Text='<%# Eval("Total") %>' runat="server" /></td>
                            <td style="padding-left:30px;font-weight:normal; text-align:left;">
                ...
                <EditItemTemplate>                   
                      <table  class="TableClass" >          
                        <tr class="theadColumn">
                            <td>
                                <asp:Label ID="Label7" runat="server"   Text="Purchase Number" Width="150px" />
                            </td>
                            <td>
                        ...
                        <tr class="theadColumn">
                            ...
                            <td>
                                <asp:Label ID="Label5"   Text="Purchase Date" runat="server" />
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                              ...
                              <td>
                                <asp:TextBox ID="txtPurchaseDate" Text='<%# Bind("PurchaseDate","{0:dd/MM/yyyy}")  %>'  Enabled="false" runat="server"></asp:TextBox>                               
                               ...
                               <asp:CalendarExtender ID="ce1" runat="server"   TargetControlID="txtPurchaseDate"   CssClass="MyCalendar"
                ...
                <table  class="TableClass">                       
                        ...
                        <tr >
                            ...
                            <td > <asp:Label ID="PurchaseOrderTotal1"  Text='<%# Eval("ItemTotal") %>' runat="server" /></td>
                             <td style="padding-left:30px;font-weight:normal; text-align:left;">
                             <asp:Label ID="CustomerRow4" runat="server"></asp:Label>                                
                            </td>  
                        </tr>                      
...
<table cellpadding="2" border="0" cellspacing="0" width="1220px" style="height: 0px;">
        <tr>
            <td style="width: 5px;">
                <asp:ImageButton ID="imgAdd" Height="20px" runat="server" ImageUrl="~/PurchaseOrder/Images/iADD.bmp"
                    AlternateText="Add" OnClick="imgAddItem_Click"  CausesValidation="false" ToolTip="Add ">
                </asp:ImageButton>
            </td>
           <%-- <td style="width: 5px;">
                <asp:ImageButton ID="imgEdit" Height="22px" runat="server" ImageUrl="~/PurchaseOrder/Images/iEdit.gif"
                    AlternateText="Edit" OnClick="imgEditItem_Click" ToolTip="Edit "></asp:ImageButton>
            </td>--%>
            <td style="width: 5px;">
                <asp:ImageButton ID="imgDelete" Height="22px" runat="server" ImageUrl="~/PurchaseOrder/Images/iDel.png"
                    AlternateText="Delete" OnClick="imgDeleteItem_Click" CausesValidation="false" ToolTip="Delete"
                    ></asp:ImageButton>
            </td>
            <td style="width: 5px;">
                <asp:ImageButton ID="imgSave" Height="22px" runat="server" ImageUrl="~/PurchaseOrder/Images/iSave.gif"
                    AlternateText="Update" OnClick="imgUpdateItem_Click" ToolTip="Save "></asp:ImageButton>
            </td>
            <td style="width: 5px;">
                <asp:ImageButton ID="imgCancel" Height="22px" runat="server" ImageUrl="~/PurchaseOrder/Images/iCan.gif"
    ...
    <Columns>        
        <asp:TemplateField HeaderText="Select">
         ...
         <ItemTemplate>
            ...
            <asp:Label ID="lblPurchaseID" Text='<%# Bind("PurchaseID") %>' CssClass="HiddenClass" runat="server"   />
        ...
        <asp:TemplateField HeaderText="Item Code / Type"  >
            ...
            <ItemTemplate>             
                ...
                <asp:AutoCompleteExtender ID="AutoCompleteExtender2" runat="server" TargetControlID="txtCode"
                    ServiceMethod="GetItemsOnDemand" ServicePath="~/PurchaseOrder/PurchaseService.asmx" MinimumPrefixLength="1"
        ...
        <asp:TemplateField HeaderText="Item Description / Specification" >           
            <ItemTemplate>
                ...
                <%-- <asp:AutoCompleteExtender ID="AutoCompleteExtender3" runat="server" TargetControlID="txtItemDescription"
                    ServiceMethod="GetItemDescriptionsOnDemand" ServicePath="~/PurchaseOrder/PurchaseOrderService.asmx" MinimumPrefixLength="1"
                    CompletionInterval="1000" CompletionSetCount="20" DelimiterCharacters=";, :">
                </asp:AutoCompleteExtender>--%>
        ...
        <asp:TemplateField HeaderText="Received"  >          
            <ItemTemplate>
             <asp:Label ID="c12" runat="Server" Width="60px"  Visible='<%# !(bool) IsInEditMode %>' Text='<%# Eval("ReceivedQuantity","{0:N2}") %>' />                                                     
            </ItemTemplate>
        </asp:TemplateField>
   ...
   <asp:GridView ID="TermsGridView" runat="server" 
    ...
    <Columns>     
        ...
        <EditItemTemplate>
         ...
         <asp:TextBox ID="txtPurchaseID" Text='<%# Bind("PurchaseID") %>' CssClass="HiddenClass" runat="server"   />
        </EditItemTemplate>
        </asp:TemplateField>                            
...
<asp:ObjectDataSource ID="ODODS" runat="server" TypeName="PurchaseOrder.Buslogic.Purchase" ConflictDetection="CompareAllValues"
    SelectMethod="GetPurchase" DataObjectTypeName="PurchaseOrder.Data.PurchaseData"
   ...
   <%--<td>          
                            <asp:AutoCompleteExtender ID="ACE3" runat="server"
                                ...
                                ServicePath="PurchaseOrder.PurchaseOrderService.asmx"
