...
using WC = PurchaseOrder.Common.WebCommon;
...
namespace PurchaseOrder.Forms
{
    public partial class ManagePurchase : System.Web.UI.Page
    {
        ...
        protected string RequestPurchaseID
        {
            get
            {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (RequestPurchaseID != string.Empty)
                {   //case of amend                    
        ...
        { 
            ...
            EnumClass.Status status = (EnumClass.Status)Purchase.GetPurchaseStatus(RequestPurchaseID);
        ...
        {            
            try
            {
                ...
                PurchaseData oData = CopyUIToPurchaseDataObject();
                DataSet dsItems = (DataSet)ViewState["Items"];
                DataSet dsTerms = (DataSet)ViewState["Terms"];
                ArrayList sqlCommands = new ArrayList();
                string updateSql = ASM.Core.SetClassPropertiesValuesToSql(oData, "UPDATE", "Purchase");
                sqlCommands.Add(updateSql);
                if (dsItems != null)
                {
                    dsItems.Tables[0].Columns.Remove("ReceivedQuantity");
                    sqlCommands.AddRange(ASM.Core.GetSQLFromDataTable(new PurchaseItemData(), dsItems.Tables[0], "PurchaseItem"));
                }
                if (dsTerms != null)
                    sqlCommands.AddRange(ASM.Core.GetSQLFromDataTable(new PurchaseTermData(), dsTerms.Tables[0], "PurchaseTerm"));

                int[] x = WC.UpdatePurchaseToDbUsingTransaction(sqlCommands);
                ClearViewState();
                if (x[0] < 0)
                {
                    //Error
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                Purchase.UpdatePurchaseStatus(RequestPurchaseID);
                ...
                //if (Inventory.Common.WebCommon.InsertPurchaseItemsToProductMasterTransactions(RequestPurchaseID))
                //{
                   
                //    CheckStatus();
                //}
                Response.Redirect("~/PurchaseOrder/Forms/ManageOrder.aspx?ID=" + RequestPurchaseID, false);
        ...
        protected void btnCancel_Click(object sender, EventArgs e)
        {
            ...
            {
                ClearViewState();
                Response.Redirect("~/PurchaseOrder/Forms/SearchOrders.aspx", false);
            }
        ...
        { 
            try
            {
                ...
                DataSet dsItems = (DataSet)ViewState["Items"];
                DataSet dsTerms = (DataSet)ViewState["Terms"];
                string insertSql = ASM.Core.SetClassPropertiesValuesToSql(oData, "INSERT", "Purchase");
                ...
                int x = WC.InsertPurchaseToDbUsingTransaction(sqlCommands);
                ViewState["Items"] = null;
                ViewState["Terms"] = null;
                ViewState["ItemKey"] = null;
                ...
                {
                    Response.Redirect("~/PurchaseOrder/Forms/ManageOrder.aspx?ID=" + x.ToString(), false);
                    ODView.DataBind();
                } 
            }
            catch (Exception exc)
        ...
        public PurchaseData CopyUIToPurchaseDataObject()
        {
            int temp = 0;
            oData = new PurchaseData();
            try
            {
          ...
          //  TextBox requestedFor = ODView.Rows[0].FindControl("txtrequestedFor") as TextBox;
            ...
            TextBox PurchaseDate = ODView.Rows[0].FindControl("txtPurchaseDate") as TextBox;
            ...
            {
                oData.PurchaseDate = DateTime.ParseExact(PurchaseDate.Text, "dd/MM/yyyy", null);
            }
            else
            {
                oData.PurchaseDate = DateTime.Now;
            }
        ...
        public void PopulateItemsGrid()
        {
            ...
            DataSet ds = OI.GetPurchaseItems(PurchaseID);
            ViewState["Items"] = ds;
        ...
        protected void ItemChanged(object sender, EventArgs e)
        {
            ...
            //catch (Exception exc)
            //{
            //    ErrorLog.addError("PurchaseOrderControl:ItemChanged()", exc.Message);
            //}
        ...
        protected void imgUpdateItem_Click(object sender, EventArgs e)
        {
            ...
            //    Single subTotal = 0.0F;
            //    Single parseValue = 0.0F;
            //    Single taxValue = 0.0F;
            //    Single discountValue = 0.0F;
            //    int parseValueInt = 0;
            //    try
            //    {
            ...
            //        TextBox txtPurchaseID = (TextBox)ItemsGridView.Rows[index].FindControl("txtPurchaseID");
            ...
            //        Label txtDiscountAmount = (Label)ItemsGridView.Rows[index].FindControl("lblDiscountAmount");
            //        Label txtSubTotal = (Label)ItemsGridView.Rows[index].FindControl("lblSubTotal");
            ...
            //            {
            //                Int32.TryParse(txtPurchaseID.Text, out parseValueInt);
            ...
            //                dr["Rate"] = parseValue;
            //                subTotal = totalValue * parseValue;
            //                dr["SubTotal"] = subTotal;
                            
            //                float.TryParse(txtDiscount.Text, out discountValue);
            //                dr["Discount"] = discountValue;
            //                float.TryParse(txtTax.Text, out taxValue);
            //                dr["Tax"] = taxValue;

            //                if (subTotal > 0)
            //                {
            //                    dr["DiscountAmount"] = ((subTotal *  discountValue) / 100);
            //                    dr["TaxAmount"] = (subTotal * taxValue) / 100;

            //                    totalValue = subTotal - ((subTotal * discountValue) / 100) - (subTotal * taxValue) / 100; 
            //                }
        ...
        public void UpdateGridViewDetailsToDataTable()
        {
            ...
            foreach (GridViewRow GRow in ItemsGridView.Rows)
            {
                ...
                string PurchaseID = RequestPurchaseID;
                ...
                {                    
                    ...
                    if (dr.RowState != DataRowState.Deleted && dr.RowState != DataRowState.Detached)
                    {
                        if (dr["ID"].ToString() == ID.Text)
                        {
                            Int32.TryParse(PurchaseID, out parseValueInt);
                            if (parseValueInt == 0 && !string.IsNullOrEmpty(Request.QueryString["ID"]))
                            {
                                parseValueInt = Convert.ToInt32(Request.QueryString["ID"].ToString());
                            }
        ...
        public void PopulateTermsGrid()
        {
            ...
            PurchaseTerm OI = new PurchaseTerm();
            DataSet ds = OI.GetPurchaseTerms(PurchaseID);
            ViewState["Terms"] = ds;
        ...
        protected void imgUpdateTerm_Click(object sender, EventArgs e)
        {
            ...
            if (ViewState["TermKey"] != null)
            {
                ...
                if ((TermsGridView.Rows[index].RowState & DataControlRowState.Edit) > 0)
                {
                    ...
                    TextBox txtPurchaseID = (TextBox)TermsGridView.Rows[index].FindControl("txtPurchaseID");
