<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchOrders.aspx.cs" Culture ="en-GB"  Theme="Default" MasterPageFile ="~/PurchaseOrder/PurchaseOrder.Master" Inherits="PurchaseOrder.Forms.SearchPurchases" %>
...
<asp:Content ID="PurchaseOrder" ContentPlaceHolderID="main" runat="server">  
<ul id="breadcrumb">
    <li><a href="../../Default.aspx" title="Navigation"><img src="../../Images/breadcrumbs_home.png" alt="Navigation" class="home" /></a></li>
    <li style="width:80px;"><a href="SearchPurchases.aspx" title="Purchase"><b>I&nbsp;-&nbsp;Purchase</b></a> </li>
    <li>Search Purchases</li>
    </ul>
...
<table >
  ...
  <asp:Panel ID="AddDeleteButtonPanel" runat="server">
        ...
        <td>
         <asp:ImageButton runat="server" ID="DeleteButton" AlternateText="Delete Purchase" ToolTip="Delete Purchase"
         OnClick="DeleteButton_Click" ImageUrl="~/Images/iBin.gif" OnClientClick="return confirm('Are you sure you want to delete this PurchaseOrder! Do you want to continue ?')" />         
        </td>         
        <%--<td>
        <asp:ImageButton runat="server" ID="AddNewButton" AlternateText="Add New Purchase" ToolTip="Add New Purchase"
   ...
   <div>
    <br />
    <asp:GridView ID="PurchaseOrderGridView" runat="server" AutoGenerateEditButton="false" 
    AutoGenerateDeleteButton="false" AutoGenerateColumns="false" SkinID="metro" OnRowCommand="PurchaseOrderGridView_RowCommand"
    ShowFooter="true"   DataKeyNames="ID" DataSourceID="ODODS" OnRowCreated="PurchaseOrderGridView_RowCreated"  >  
    
    <Columns>   
         
    <asp:TemplateField ItemStyle-Width="10px"> 
    <HeaderTemplate>
    <asp:ImageButton runat="server" ID="Copy" ImageUrl="~/Images/imgCopy.png" ToolTip="Create a copy from existing Purchase" /> <%--OnClick="CopyBtnClick" --%>
    </HeaderTemplate>    
     <ItemTemplate>   
     ...
     <td style="border:0px;width:25px;"></td>       
     <td style="border:0px;width:25px;">Purchase #</td>
     <td style="border:0px;width:400px;">Customer</td>
     <td style="border:0px;width:100px;">Item Total</td>
     <td style="border:0px;width:100px;">Purchase Date</td>
    ...
    <%-- <td style="border:0px;width:10%;">Requested For</td>--%>
     ...
     <td style="border:0px;width:100px;"><%# Eval("PurchaseDate","{0:dd/MM/yyyy}")  %> </td>
     ...
     <asp:Panel ID="pnlPurchaseOrderItem" runat="server" CssClass="LeftSide"  Width="100%"     >
    ...
    TypeName="PurchaseOrder.BusLogic.PurchaseItem" ConflictDetection="CompareAllValues"
    SelectMethod="GetPurchaseItems" DataObjectTypeName="PurchaseOrder.Data.PurchaseItemData" >
    <SelectParameters>   
    <asp:Parameter Name="PurchaseID" Type="String" DefaultValue="" />
    </SelectParameters>    
    </asp:ObjectDataSource>         
     <ajax:CollapsiblePanelExtender ID="cpe" runat="Server"  
     TargetControlID="pnlPurchaseOrderItem" CollapsedSize="0" Collapsed="True"  
     ExpandControlID="imgCollapsible"     CollapseControlID="imgCollapsible"
     AutoCollapse="False" AutoExpand="False" ScrollContents="false" 
     ImageControlID="imgCollapsible" ExpandedImage="~/PurchaseOrder/Images/iSUB.bmp" 
     CollapsedImage="~/PurchaseOrder/Images/iADD.bmp" ExpandDirection="Vertical" />
    ...
    TypeName="PurchaseOrder.BusLogic.Purchase" ConflictDetection="CompareAllValues"
    SelectMethod="GetPurchases" DataObjectTypeName="PurchaseOrder.Data.PurchaseData" CacheDuration="0" >
    <SelectParameters> 
