<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucAdvanceTransactions.ascx.cs" Inherits="Payroll.Controls.ucAdvanceTransactions" %>
<script type="text/javascript" >
function SetAdvanceSource(SourceID)
    {
        var hidSourceID =document.getElementById("<%=AdvanceTransactionsField.ClientID%>");
        hidSourceID.value = SourceID;
    }
</script>
 <asp:HiddenField ID="AdvanceTransactionsField" runat="server" />
...
<%--<span style="float:left;padding-top:15px;">--%>
 ...
 <asp:ImageButton runat="server" ID="Updatebtn" AlternateText="Update Leave Transaction" ToolTip="Update Leave Transaction"
         OnClick="Updatebtn_Click" ImageUrl="~/Images/iSave.gif" Visible="false" OnClientClick = "SetAdvanceSource(this.id)" /> 
...
AllowPaging="true" PageSize="12" OnPageIndexChanging="gView_PageIndexChanged" SkinID="metro" Width="100%" >
<EmptyDataTemplate>
...
<Columns>
    ...
    <asp:TemplateField HeaderText="Year" SortExpression="YearName" >
     ...
     <asp:TemplateField HeaderText="Comments" SortExpression="Comments" HeaderStyle-Width="50%" >      
     <ItemTemplate>          
