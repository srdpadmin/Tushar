<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageBilling.aspx.cs"  MasterPageFile="~/Billing/Billing.Master" 
Theme="Default" Inherits ="Billing.Forms.ManageBilling" %>
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <table  class="TableClass"  cellpadding="0px" cellspacing="0px">
                        <tr class="theadColumn">
                            <td>
                                <asp:Label ID="LblQO" runat="server"   Text="Bill Number" />
                            </td>
                            <td>
                        ...
                        <tr class="theadColumn">
                            ...
                            <td>
                                <asp:Label ID="LblBillDate"    Text="BillDate" runat="server" />
                            </td>              
                        ...
                        <tr>
                           ...
                           <td>
                               <asp:Label ID="BillDateLbl" Text='<%# Eval("BillDate","{0:dd/MM/yyyy}")  %>' runat="server"></asp:Label>                               
                        ...
                        <tr class="theadColumn">
                            ...
                            <td > <asp:Label ID="BillingTotal"  Text="Total" runat="server" /></td>
                            <td style="padding-left:30px;font-weight:normal; text-align:left;">
                        ...
                        <tr >
                            ...
                            <td >  <asp:Label ID="BillingTotal1"  Text='<%# Eval("Total") %>' runat="server" /></td>
                            <td style="padding-left:30px;font-weight:normal; text-align:left;">
                ...
                <EditItemTemplate>                   
                      <table  class="TableClass" >          
                        <tr class="theadColumn">
                            <td>
                                <asp:Label ID="Label7" runat="server"   Text="Bill Number" Width="150px" />
                            </td>
                            <td>
                        ...
                        <tr class="theadColumn">
                            ...
                            <td>
                                <asp:Label ID="Label5"   Text="Bill Date" runat="server" />
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                              ...
                              <td>
                                <asp:TextBox ID="txtBillDate" Text='<%# Bind("BillDate","{0:dd/MM/yyyy}")  %>'  Enabled="false" runat="server"></asp:TextBox>                               
                ...
                <table  class="TableClass">                       
                        ...
                        <tr >
                            ...
                            <td > <asp:Label ID="BillingTotal1"  Text='<%# Eval("ItemTotal") %>' runat="server" /></td>
                             <td style="padding-left:30px;font-weight:normal; text-align:left;">
                             <asp:Label ID="CustomerRow4" runat="server"></asp:Label>                                
                            </td>  
                        </tr>                      
    ...
    <Columns>        
        <asp:TemplateField HeaderText="Select">
         ...
         <ItemTemplate>
            ...
            <asp:Label ID="lblBillID" Text='<%# Bind("BillID") %>' CssClass="HiddenClass" runat="server"   />
        ...
        <asp:TemplateField HeaderText="SubTotal" FooterStyle-CssClass="columnBorder" >                     
            ...
            <EditItemTemplate>
                <asp:Label ID="lblSubTotal" runat="server"  Width="70px" Visible='<%# !(bool) IsInEditMode %>' Text='<%# Bind("SubTotal","{0:N2}") %>'  />
            </EditItemTemplate>            
             <FooterTemplate>            
   ...
   <asp:GridView ID="TermsGridView" runat="server" 
    ...
    <Columns>     
        ...
        <EditItemTemplate>
         ...
         <asp:TextBox ID="txtBillID" Text='<%# Bind("BillID") %>' CssClass="HiddenClass" runat="server"   />
        </EditItemTemplate>
        </asp:TemplateField>                            
...
<asp:ObjectDataSource ID="ODODS" runat="server" TypeName="Billing.Buslogic.Bill" ConflictDetection="CompareAllValues"
    SelectMethod="GetBill" DataObjectTypeName="Billing.Data.BillData"
