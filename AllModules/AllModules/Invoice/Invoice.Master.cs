...
namespace Invoice
{
    public partial class Site : System.Web.UI.MasterPage
    {
        ...
        {
            Response.Redirect("~/Contact/Forms/ManageContacts.aspx?Invoice");
        }
        protected void lnkManageTermsConditions_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/TermsConditions/Forms/ManageTermsConditions.aspx?Invoice");
        }
        protected void lnkProductMaster_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Inventory/Forms/ManageProductMaster.aspx?Invoice");
        }
